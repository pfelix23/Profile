            ...
            <div className="containers">
                ...
                <div className="container-two">
                    <div className="project-information">
                        ...
                        <p><strong>Project Date: </strong> January, 2025</p>
                        <p style={{display:'flex'}}><strong>URL: </strong><div style={{color:'rgb(23, 107, 155)'}}>&nbsp;https://equitrack-5ecf.onrender.com</div></p>
                        <div style={{marginLeft:'15px', width:'50%'}}><a href="https://equitrack-5ecf.onrender.com" target="_blank" rel="noreferrer" className="button-15" style={{fontSize:'17px', display:'flex', justifyContent:'center', alignItems:'center', fontFamily:'Raleway', border:'none', color:'white', backgroundColor:'rgb(23, 107, 155)', textDecoration:'none'}}><Globe style={{height:'18px', width:'18px'}}/>&nbsp;Visit Website</a></div>
                    </div>
                    <div className="project-details">
                        <h2>About {active}:</h2>
                        <p>
                            EquiTrack is a financial tracking and forecasting application which tracks assets, liabilities and investments.
                            Built an asset management page using React, Redux, Chart.js, and API integration for dynamic financial data and interactive charts.
                            Developed RESTful APIs in Express.js for investment management with authentication, CRUD operations, and dynamic calculations.
                        </p>
                        <section style={{display:'flex', justifyContent:'space-around'}}>
                            ...
                            <div className="tech-tile"><Icon icon="logos:express" width={36} /></div>
