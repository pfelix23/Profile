...
function Profile() {
    ...
    return (
        <div className='root'>
            ...
            <br /> <br /> ● <a href="https://drive.google.com/file/d/1v95zlP5MCdDMRBfnCGcTZfnXvOC-8w8d/view?usp=sharing" target="_blank" rel="noreferrer" className='resume'>Resume PDF</a></p></span><span><h3>Education Full Stack Software Engineering</h3><p style={{lineHeight:'1.4', color:'#3e3f41'}}>App Academy, San Francisco, CA <br /><br />
